...
diary.list_allgood = async(json)=>{
    ...
    */
    ...
    let sql   =  " select  to_char(d.create_date, 'DD-MM-YYYY') as create_date, d.good"
        sql  +=  " from diary d " 
        sql  +=  " left join users u on d.user_id = u.user_id where u.user_id =" +json.user_id; 
...
diary.list_allbad = async(json)=>{
    ...
    */
    ...
    let sql   =  " select  to_char(d.create_date, 'DD-MM-YYYY') as create_date, d.bad"
        sql  +=  " from diary d " 
        sql  +=  "left join users u on d.user_id = u.user_id where u.user_id =" +json.user_id; 
    ...
    diary.list_allwish = async(json)=>{
        ...
        */
        ...
        let sql   =  " select  to_char(d.create_date, 'DD-MM-YYYY') as create_date, d.wish"
            sql  +=  " from diary d " 
            sql  +=  "left join users u on d.user_id = u.user_id where u.user_id =" +json.user_id; 
...
diary.select_diary = async(json)=>{
    ...
    */
    ...
    let sql  =  " select d.diary_id, to_char(d.create_date, 'DD-MM-YYYY') as create_date, d.title, d.good, d.bad, d.wish, d.feel_id, f.feel_name  "
        ...
        sql +=  " and craete_date(d.create_date) = '" +json.create_date+"'";
